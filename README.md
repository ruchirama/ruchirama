...
> Specialized in **Business Intelligence**, **Project Manager**, **Strategic Operations & Supply Chain** & **AI-driven Digital Transformation**. Master's-educated in both **Information Technology** and **Business Studies** with proven track record of delivering measurable results.
...
- 🏆 **Monbukagakusho Honors Scholarship** recipient (Japan, 2023)
...
|--------|------------|--------|----------|
| 🎓 **Master of Science - IT** | Kyoto College of Graduate Studies | 2023-2024 | Japan |
...
| 🧵 **Textile & Clothing Technology** | University of Moratuwa | 2016-2019 | Sri Lanka |
...
- Automation strategies for resilient networks
- Future trend analysis and forecasting models
...
- Workforce stability improvement plans
...
- Hand-gesture controlled LED signals
...
|:---:|:---:|:---:|:---:|
| Power BI Dashboards | Procurement Optimization | Agile Methodologies | GOTS Certification |
| Predictive Analytics | Vendor Management | Cross-functional Leadership | Eco-friendly Sourcing |
| KPI Development | Inventory Control | Stakeholder Engagement | Green Manufacturing |
...
professional_profile = {
    ...
    "technical_skills": {
        "business_intelligence": ["Power BI", "Tableau", "SQL", "Excel"],
        "programming": ["Python", "JavaScript", "PHP"],
        "frameworks": ["React", "Next.js", "Django", "Node.js"],
        "data_science": ["TensorFlow", "Pandas", "Scikit-learn", "PyTorch"],
...
|:---|:---:|:---|
| 📉 Procurement Lead Time | **-25%** | Supply Chain Efficiency |
| 📊 Inventory Accuracy | **+40%** | Operations Management |
| ✅ On-Time Delivery | **97%** | Customer Satisfaction |
| 🌱 Eco-Friendly Sourcing | **100%** | Sustainability |
...
*"Transforming data into actionable insights, driving sustainable innovation in the textile industry through the power of AI, Business Intelligence, and strategic project management."*
